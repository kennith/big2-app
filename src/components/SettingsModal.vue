...
<template>
  <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fade-in">
    <div class="w-full max-w-md bg-slate-900 border border-slate-700 rounded-3xl p-5 sm:p-6 shadow-2xl flex flex-col gap-4 text-slate-200">
      <!-- Modal Header -->
      ...
      <div class="space-y-4 text-xs sm:text-sm">
        ...
        <div class="p-3 rounded-2xl bg-slate-800/80 border border-slate-700/60 space-y-2">
        ...
        <!-- Sound Toggle -->
        <div class="flex items-center justify-between p-3 rounded-2xl bg-slate-800/80 border border-slate-700/60">
          <div>
          ...
          <button
            ...
            class="w-12 h-6 rounded-full transition-colors relative border border-white/10"
        ...
        <!-- Volume Slider -->
        <div v-if="settings.soundEnabled" class="p-3 rounded-2xl bg-slate-800/80 border border-slate-700/60 space-y-2">
        ...
        <div class="p-3 rounded-2xl bg-slate-800/80 border border-slate-700/60 space-y-2">
          ...
          <div class="grid grid-cols-3 gap-2">
            <button
              ...
              class="py-1.5 rounded-xl border text-xs font-semibold transition"
              :class="
      ...
      <div class="pt-2 border-t border-slate-800 flex justify-end">
        <button
          @click="$emit('close')"
          class="px-5 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 active:scale-95 text-slate-200 font-bold text-xs sm:text-sm border border-slate-700 transition"
        >
          {{ t.close }}
        </button>
      </div>
